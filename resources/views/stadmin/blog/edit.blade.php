                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('serviceProviderBlog.blogUpdate', $blog->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" value="{{asset('assets/images/blogs')}}/{{$blog->image}}" id="image" name="image" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" value="{{asset('assets/images/blogs/thumbnails')}}/{{$blog->thumbnail}}" id="thumbnail" name="thumbnail" required>
