...
<div>
    ...
    <div class="inner-banner-one position-relative">
        ...
        <img src="{{ asset('images/lazy.svg')}}" data-src="{{ asset('images/shape/shape_02.svg')}}" alt="" class="lazy-img shapes shape_01">
        <img src="{{ asset('images/lazy.svg')}}" data-src="{{ asset('images/shape/shape_03.svg')}}" alt="" class="lazy-img shapes shape_02">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-5 col-md-5">
                                <div class="pricing-card-one border-0 mt-25">
                                    ...
                                    <img class="align-self-center img-fluid" src="{{asset('image/services')}}/{{$service->image}}" width="50">
                                </div>
                                <!-- /.pricing-card-one -->
                            </div>
