                    ...
                    <div class="product-details">
                        ...
                        <div class="details-filter-row details-row-size">
                            <div class="product-price">
                                ...
                                <p>Discount:<span><?php echo e($service->discount); ?></span></p>
                                <p><span><?php $total = $total-$service->discount; ?></span></p>
                                <?php elseif($service->discount_type == 'percent'): ?>
                                <p>Discount:<span><?php echo e($service->discount); ?>%</span></p>
                                <p><span><?php $total = $total-($total*$service->discount/100); ?></span></p>
                                <?php endif; ?>
                                <?php endif; ?>
...
</div><!-- End .page-content --><?php /**PATH C:\Users\HP\Downloads\hiletask\hiletask\resources\views/livewire/service-details-component.blade.php ENDPATH**/ ?>