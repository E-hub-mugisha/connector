...
<?php $component->withAttributes([]); ?>
                 ...
                 <?php $__env->slot('content', null, []); ?> 
                    ...
                    <div class="flex items-center mt-5">
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'jetstream::components.button','data' => ['class' => 'btn btn-primary','wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn btn-primary','wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
...
</div><?php /**PATH C:\Users\kabos\Downloads\hiletask\hiletask\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>