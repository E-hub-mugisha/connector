...
<div>
    <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        <div class="container">
            <h1 class="page-title"><?php echo e($scategory->name); ?><span>Services</span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
    <nav aria-label="breadcrumb" class="breadcrumb-nav mb-2">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#"><?php echo e($scategory->name); ?></a></li>
                ...
                <aside class="col-lg-2 order-lg-first">
                    <div class="sidebar sidebar-shop">
                        ...
                        <div class="widget widget-collapsible">
                            <h3 class="widget-title <?php echo e(count($scategory->subcategories) > 0 ? 'has-child-cate':''); ?>">
...
</div><?php /**PATH C:\Users\kabos\Downloads\hiletask\hiletask\resources\views/livewire/service-by-category-component.blade.php ENDPATH**/ ?>