<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
    <div class="container">
        <h1 class="page-title"><?php echo e($blog->title); ?></h1>
    </div><!-- End .container -->
</div><!-- End .page-header -->
            ...
            <div class="col-lg-9">
                <article class="entry single-entry">
                    <figure class="entry-media">
                        <img src="<?php echo e(asset('assets/images/blogs/thumbnails')); ?>/<?php echo e($blog->thumbnail); ?>" alt="image desc">
                    ...
                    <div class="entry-body">
                        ...
                        <div class="entry-content editor-content">
                            ...
                            <img src="<?php echo e(asset('assets/images/blogs')); ?>/<?php echo e($blog->image); ?>" alt="image" class="float-left">
                        ...
                        <div class="entry-footer row no-gutters flex-column flex-md-row">
                            <div class="col-md">
                                <div class="entry-tags">
                                    <span>Post visitors:</span> <a href="#"><?php echo e($blog->views); ?></a>
                                </div><!-- End .entry-tags -->
                            </div><!-- End .col -->
                            ...
                            <li>
                                <div class="comment">
                                    <figure class="comment-media">
                                        <a href="#">
                                            <img src="<?php echo e(asset('assets/images/blog/comments/3.jpg')); ?>" alt="User name">
                                        </a>
                                    </figure>
                        ...
                        <article class="entry entry-grid">
                            <figure class="entry-media">
                                <a href="<?php echo e(route('home.blog_detail',['blog_slug'=>$blog->slug])); ?>">
                                    <img src="<?php echo e(asset('assets/images/blogs/thumbnails')); ?>/<?php echo e($r_blog->thumbnail); ?>" alt="<?php echo e($r_blog->slug); ?>">
                                </a>
                            </figure><!-- End .entry-media -->

                            <div class="entry-body">
                                <div class="entry-meta">
                                    <a href="#"><?php echo e($r_blog->created_at); ?></a>
                                    <span class="meta-separator">|</span>
                                    <a href="#">2 Comments</a>
                                </div><!-- End .entry-meta -->

                                <h2 class="entry-title">
                                    <a href="<?php echo e(route('home.blog_detail',['blog_slug'=>$blog->slug])); ?>"><?php echo e($r_blog->title); ?></a>
                                </h2><!-- End .entry-title -->

                                <div class="entry-cats">
                                    in <a href="#"><?php echo e($r_blog->blog_category); ?></a>
                                </div><!-- End .entry-cats -->
                            </div><!-- End .entry-body -->
                        </article><!-- End .entry -->
                ...
                <div class="sidebar">
                    <div class="widget">
                        ...
                        <ul class="posts-list">
                            ...
                            <li>
                                ...
                                <div>
                                    <span><?php echo e($r_blog->created_at); ?></span>
                                    <h4><a href="<?php echo e(route('home.blog_detail',['blog_slug'=>$blog->slug])); ?>"><?php echo e($r_blog->title); ?></a></h4>
                                </div>
                            </li>
                        </ul><!-- End .posts-list -->
                        <?php endif; ?>
                    ...
                    <!-- <div class="widget widget-banner-sidebar">
                        ...
                        <div class="banner-sidebar">
                            <a href="#">
                                <img src="<?php echo e(asset('assets/images/blog/sidebar/banner.jpg')); ?>" alt="banner">
                            </a>
                        </div>
                    </div> -->
...
</div><!-- End .page-content --><?php /**PATH C:\Users\HP\Downloads\hiletask\hiletask\resources\views/livewire/blog-detail-component.blade.php ENDPATH**/ ?>