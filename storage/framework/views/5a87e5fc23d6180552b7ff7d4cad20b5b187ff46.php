                    ...
                    <article class="blog-meta-two mt-15 xs-mt-20 wow fadeInUp">
                        <figure class="post-img m0">
                            <a href="<?php echo e(route('home.blog_detail',['blog_slug'=>$blog->slug])); ?>" class="w-100 d-block">
                                <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('image/blog')); ?>/<?php echo e($blog->image); ?>" alt="" class="lazy-img w-100 tran4s"></a>
                            <a href="<?php echo e(route('home.blog_detail',['blog_slug'=>$blog->slug])); ?>" class="tags fw-500"><?php echo e($blog->blog_category); ?></a>
                        </figure>
                        <div class="post-data mt-15 lg-mt-20">
                            <div class="date"><span class="fw-500 text-dark">Created By:</span> <a href="#"><?php echo e($blog->author->name); ?></a></div>
...
<?php /**PATH C:\Users\kabos\OneDrive\Desktop\jerome\hiletask\resources\views/pages/blogContent.blade.php ENDPATH**/ ?>