    ...
    <section class="category-section-two position-relative pt-150 lg-pt-100 pb-140 lg-pb-80">
        <div class="container">
            ...
            <div class="card-wrapper row mt-80 lg-mt-40">
                ...
                <div class="col-lg-3 text-center col-md-4 col-sm-6 d-flex">
                    <div class="card-style-four tran3s w-100 mt-30 wow fadeInUp">
                        <a href="<?php echo e(route('home.service_by_category',['category_slug'=>$scategory->slug])); ?>" class="d-block">
                            <div class="icon tran3s d-flex justify-item-center ">
                                <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('assets/images/category')); ?>/<?php echo e($scategory->image); ?>" alt="<?php echo e($scategory->name); ?>" class="lazy-img">
                            </div>
                            <div class="title tran3s fw-500 text-lg"><?php echo e($scategory->name); ?></div>
                            ...
                            <a class="total-job" href="<?php echo e(route('home.service_by_subcategory', ['subcategory_slug' => $scat->slug])); ?>">
            ...
            <!-- /.card-wrapper -->
            <div class="text-center d-sm-none mt-50"><a href="<?php echo e(route('home.service_categories')); ?>" class="btn-six border-0">All Categories <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('asset/images/shape/shape_23.svg')); ?>" alt="" class="lazy-img shapes"></a></div>
        </div>
        <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('asset/images/shape/shape_24.svg')); ?>" alt="" class="lazy-img shapes shape_01">
    </section>
    <!-- ./category-section-two -->
                                ...
                                <div class="d-flex">
                                    <div class="cadidate-avatar online position-relative d-block me-auto ms-auto">
                                        <a href="<?php echo e(route('home.service-provider_profile',['sprovider_id'=>$sprovider->id])); ?>" class="rounded-circle">
                                            <img src="<?php echo e(asset('asset/images/lazy.svg')); ?>" data-src="<?php echo e(asset('assets/images/sproviders')); ?>/<?php echo e($sprovider->image); ?>" alt="" class="lazy-img rounded-circle">
                                        </a>
                                    </div>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kabos\OneDrive\Desktop\jerome\hiletask\resources\views/services/service-categories.blade.php ENDPATH**/ ?>