        ...
        <div class="col-lg-10 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                            <h4 class="card-title card-title-dash">Service Name:<?php echo e($portfolio->service->name); ?></h4>
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="service_id" id="service_id">
                                <option value="<?php echo e($portfolio->service_id); ?>" selected><?php echo e($portfolio->service->name); ?></option>
