                                            ...
                                            <div class="row d-flex justify-content-center align-items-center h-100">
                                                <div class="card card-stepper">
                                                    ...
                                                    <div class="card-body p-4">
                                                        <div class="d-flex row flex-row mb-4 pb-2">
                                                            <div class="col-md-6 flex-fill">
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center">
                                                                    <div>
                                                                        <p class="text-muted mb-2"> Service Provider Name: <span class="fw-bold text-body"><?php echo e($service->provider->sprovider_name); ?></span><?php echo e($service->provider->proEmail); ?></p>
                                                                    </div>
                                                                </div>
...
</div><?php /**PATH C:\Users\kabos\Downloads\hiletask\hiletask\resources\views/livewire/booking-component.blade.php ENDPATH**/ ?>