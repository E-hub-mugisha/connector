<div>
    ...
    <div class="intro-slider-container">
        <div class="intro-slider owl-carousel owl-simple owl-nav-inside" data-toggle="owl" data-owl-options='{
            ...
            <div class="intro-slide" style="background-image: url(assets/images/products/<?php echo e($product->image); ?>);">
                <div class="container intro-content">
                    <div class="row">
                        <div class="col-auto offset-lg-3 intro-col">
                            <h3 class="intro-subtitle"><?php echo e($product->stock_status); ?></h3><!-- End .h3 intro-subtitle -->
                            <h1 class="intro-title"><?php echo e($product->name); ?>

                                <span>
                                    <sup class="font-weight-light">from</sup>
                                    <span class="text-primary"><?php echo e($product->regular_price); ?><span class="text-color-success">RWF</span></span>
                                </span>
                            </h1><!-- End .intro-title -->

                            <a href="<?php echo e(route('product-detail',['product_slug'=>$product->slug])); ?>" class="btn btn-outline-primary-2">
                                <span>Shop Now</span>
...
</div><?php /**PATH C:\Users\kabos\Downloads\hiletask\hiletask\resources\views/livewire/shop/shop-component.blade.php ENDPATH**/ ?>