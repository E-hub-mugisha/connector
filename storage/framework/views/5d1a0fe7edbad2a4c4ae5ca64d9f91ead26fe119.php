                    ...
                    <form wire:submit.prevent="createService">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="tagline" value="<?php echo e(__('tagline')); ?>"><?php echo e($sprovider->id); ?></label>
                                <label for="name" class="control-label">service_provider:<?php echo e($sprovider->user->name); ?> </label>
                                <input type="text" class="form-control" name="service_provider_id" wire:model="service_provider_id" value="<?php echo e($sprovider->id); ?>">
...
</div><?php /**PATH C:\Users\HP\Downloads\hiletask\hiletask\resources\views/livewire/sprovider/add-service-component.blade.php ENDPATH**/ ?>