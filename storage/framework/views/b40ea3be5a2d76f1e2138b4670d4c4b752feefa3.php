...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.add_service_category')); ?>">Add Service Categories</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.add_service')); ?>">Add Services</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseProducts" class="collapse" aria-labelledby="headingProducts" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.products')); ?>">All Products</a>
                <a class="collapse-item" href="<?php echo e(route('admin.add_products')); ?>">Add products</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseProductCategory" class="collapse" aria-labelledby="headingProductCategory" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.product_category')); ?>">Product Category</a>
                <a class="collapse-item" href="<?php echo e(route('admin.add_product_category')); ?>">Add Product Category</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?php echo e(route('admin.add_slider')); ?>">Add Slider</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.product_order')); ?>">
            <i class="fas fa-fw fa-chart-area"></i>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.users_email')); ?>">
            <i class="fas fa-fw fa-user"></i>
...
<!-- End of Sidebar --><?php /**PATH C:\Users\kabos\Downloads\hiletask\hiletask\resources\views/livewire/admin/sidebar.blade.php ENDPATH**/ ?>