        ...
        <div class="inner-wrapper">
            <div class="row">
                ...
                <div class="col-lg-4 mb-20 footer-newsletter">
                    ...
                    <form action="/sendNewsletter" method="POST" class="d-flex">
                        <?php echo csrf_field(); ?>
...
</div> <!-- /.footer-one --><?php /**PATH C:\Users\kabos\OneDrive\Desktop\jerome\hiletask\resources\views/includes/footer.blade.php ENDPATH**/ ?>