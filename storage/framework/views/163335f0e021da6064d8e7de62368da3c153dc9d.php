...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4 form-group">
                                    <label for="brand" value="<?php echo e(__('brand')); ?>">brand</label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="short_description" value="<?php echo e(__('short_description')); ?>">description</label>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php else: ?>
                                    <img src="<?php echo e(asset('assets/images/category/products')); ?>/<?php echo e($image); ?>" width="60" />
                                    <?php endif; ?>
                                </div><!-- End .form-group -->
...
</div><!-- End .login-page section-bg --><?php /**PATH C:\Users\kabos\Downloads\hiletask\hiletask\resources\views/livewire/admin/admin-edit-product-component.blade.php ENDPATH**/ ?>