                        ...
                        <table class="table table-cart table-mobile">
                            ...
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <div class="product">
                                            <figure class="product-media">
                                                <a href="<?php echo e(route('product-detail',['product_slug'=>$item->model->slug])); ?>">
                                                    <img src="<?php echo e(asset('assets/images/products/table/product-1.jpg')); ?>" alt="Product image">
                                                </a>
                                            </figure>
                                    ...
                                    <td class="price-col">$<?php echo e($item->model->regular_price); ?></td>
                                    ...
                                    <td class="total-col">$<?php echo e($item->Subtotal()); ?></td>
...
</div><?php /**PATH D:\hile\hiletasker\resources\views/livewire/cart/cart-component.blade.php ENDPATH**/ ?>