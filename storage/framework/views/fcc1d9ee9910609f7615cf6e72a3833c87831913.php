                            ...
                            <!-- <li class="nav-item dropdown category-btn mega-dropdown-sm">
                                ...
                                <ul class="dropdown-menu category-dropdown">
                                    <li class="row gx-0">
                                        ...
                                        <div class="col-lg-6">
                                            <a href="<?php echo e(route('home.service_provider_by_category',['service_category_name'=>$sprovider->category->slug])); ?>" class="item d-flex align-items-center">
                                                ...
                                                <div class="ps-3 flex-fill">
                                                    <div class="fw-500 text-dark"><?php echo e($sprovider->category->name); ?></div>
                                    ...
                                    <li>
                                        <a href="<?php echo e(route('home.service_provider')); ?>" class="explore-all-btn d-flex align-items-center justify-content-between tran3s">
...
</header> <!-- /.theme-main-menu --><?php /**PATH C:\Users\kabos\OneDrive\Desktop\jerome\hiletask\resources\views/includes/header.blade.php ENDPATH**/ ?>